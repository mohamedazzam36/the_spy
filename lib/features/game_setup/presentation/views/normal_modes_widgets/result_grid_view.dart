...
import 'package:the_spy/features/game_setup/presentation/views/normal_modes_widgets/result_grid_view_item.dart';
    ...
    return SliverGrid.builder(
      ...
      itemBuilder: (context, index) {
        return ResultGridViewItem(
          ...
          isSpyTrue: spysVotingInfo[index].votedWord == NormalModeSettings.playersShowedWord,
        );
      },
    );
  }
