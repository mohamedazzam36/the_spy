...
import 'package:the_spy/features/game_setup/presentation/views/normal_modes_widgets/players_swaping_animation_controller.dart';
              ...
              child: Padding(
                ...
                child: Text(
                  controller.isSpyShowed
                      ? NormalModeSettings.spysList[controller.currentSpyIndex].name
                      : AppServices.playersList[controller.currentPlayerIndex].name,
